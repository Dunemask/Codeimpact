...
randomWebsite='https://www.totallyuselesswebsites.com/'
...
def getLowerLinks(site):
    try:
        ...
        print("NO LINK FOUND! Reverting to another site!")
        r = requests.get("http://dunemask.mynetgear.com/")
        pass
